...
public class DriveSubsystem extends SubsystemBase {
  ...
  public Command switchPathCommand(boolean right){
    if (right) return followPathCommand(getPathRight(getNearestPath()));
    else return followPathCommand(getPathLeft(getNearestPath()));
  }
  public Command reefLeftCommand() {
    return switchPathCommand(false);
  }
  public Command reefRightCommand() {
    return switchPathCommand(true);
  }
  public Command reefNearestCommand() {
    return followPathCommand(getNearestPath());
  }
